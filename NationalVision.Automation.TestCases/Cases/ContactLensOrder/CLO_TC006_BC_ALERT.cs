/* **********************************************************
 * Description : CLO_TC006_BC_ALERT.cs for Verifying alert when Right and Left
 *               BaseCurve values are not same in contact lens prescription.
                 Accept the alert message and continue create order.
 *               
 *                               
 * Date :  23-Feb-2016
 * **********************************************************
...
{
    /// <summary>
    ///  CLO_TC006_BC_ALERT.cs for Verifying alert when Right and Left
    ///  BaseCurve values are not same in contact lens prescription.
    ///  Accept the alert message and continue create order.
    /// </summary>
    class CLO_TC006_BC_ALERT : BaseCase
    {
        protected override void ExecuteTestCase()
        {
            Reporter.Chapter.Title = "Verifying PopUp When Right BC, Left BC is not same in the Prescription";
            ...
            ContactLensesProductDisplayPage.SelectPrescriptionBaseCurve(Driver, Reporter, TestData["RBC"], TestData["LBC"]);

            Step = "Verifying alert message and accept";
            ContactLensesProductDisplayPage.VerifyBaseCurveAlertMessage(Driver, Reporter);
            ...
            Step = "Verifying the Prescription options and selecting one from them and clicking Continue";

/* **********************************************************
 * Description : CLO_TC006.cs order Contact Lens without Club membership for an existing user
 *               Enter Lens Power, Qty and BC, Click order checkOut
 *               Add Patient details, select prescription option
...
{
    /// <summary>
    /// Description : CLO_TC006.cs order Contact Lens without Club membership for an existing user; Enter Lens Power, BC & Qty; 
    ///         Click order checkOut; Add Patient details; Select Prescription Option; 
    ///         Verify Product details prior to confirm order; Confirm order and check Order details after confirmation.  
    /// </summary>
    class CLO_TC006 : BaseCase
    {
        protected override void ExecuteTestCase()
        {
            Reporter.Chapter.Title = "Verifying ContactLenses Order for an existing customer, by changing the prescription options";
            ...
            ContactLensesProductDisplayPage.SelectPrescriptionPower(Driver, Reporter,
                TestData["RPOWER"],
                TestData["LPOWER"]);
            ContactLensesProductDisplayPage.SelectPrescriptionBaseCurve(Driver, Reporter,
                TestData["RBC"],
                TestData["LBC"]);

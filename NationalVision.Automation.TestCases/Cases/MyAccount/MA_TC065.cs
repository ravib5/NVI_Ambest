/* **********************************************************
 * Description : MA_TC065.cs test case for 
 ...
 *               Disable 'Auto reorder' functionality and verify success message
...
Columbus, OH 43228";
            ...
            Step = "Clicking on 'deactivate autoreorder' button and verifying the status";
            MyAccountAutoReorderPage.ClickDeactivateAutoReorderBtn(Driver, Reporter);
            MyAccountAutoReorderPage.AssertDeactivateAutoReOrderSuccessMsg(Driver, Reporter);
            MyAccountAutoReorderPage.AssertActivateAutoReOrderBtn(Driver, Reporter);
            MyAccountAutoReorderPage.ClickBackToOrderHistory(Driver, Reporter);
            string status = MyAccountAutoReorderPage.GetAutoReOrderStatus(Driver, Reporter, OrderID);
            MyAccountPage.AssertAutoReOrderStatus(Driver, Reporter, status);

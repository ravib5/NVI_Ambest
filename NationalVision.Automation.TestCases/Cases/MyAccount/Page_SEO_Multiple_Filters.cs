...
namespace NationalVision.Automation.Tests.Cases.MyAccount
{
    ...
    /// </summary>
    class Page_SEO_Multiple_Filters : BaseCase
    {
        ...
        protected override void ExecuteTestCase()
        {
            ...
            foreach (string MainlinkName in glasses)
            {
                ...
                foreach (string linkName in linkNames)
                {
                    ...
                    if (EyeGlassesShelfPage.IsShowAllLinkExist(Driver, Reporter))
                    {
                        CommonPage.ClickShowAllBrands(Driver, Reporter);
                    }

                    if (EyeGlassesShelfPage.IsShowAllLinkExist(Driver, Reporter, "frame-color"))
                    {
                        CommonPage.ClickShowAllBrands(Driver, Reporter, "frame-color");
                    }
                    ...
                    //Selenide.WaitForElementNotVisible(Driver, Util.GetLocator("Spinner_Loading_Completed"));

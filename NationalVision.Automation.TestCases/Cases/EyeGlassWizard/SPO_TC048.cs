/* **********************************************************
 * Description : SPO_TC048.cs test case for Second Pair order eyeglasses
 *                Age: over 13 
 *                Patient Info: Any Patient's Prescription Type
 *                Lens Package:  Verilite Package
 *                Optional Tint: No Tint for Frame 1 and Frame 2 and click Checkout
 *               
 * Date :  07-March-2016
 * **********************************************************
 */
...
namespace NationalVision.Automation.Tests.Cases.EyeGlassWizard
{
    ...
    /// <summary>
    /// Description : SPO_TC048.cs test case for Second Pair order eyeglasses Age: over 13,Patient Info: Any Patient's Prescription Type,
    ///              Lens Package: Verilite Package, Optional Tint: No Tint for Frame 1 Frame 2 and click Checkout
    /// </summary>
    class SPO_TC048 : BaseCase
    {
        protected override void ExecuteTestCase()
        {
            ...
            Step = "Verifying Optional Tint options and selecting No Tint for Frame 1 and Frame 2 and Clicking Next";

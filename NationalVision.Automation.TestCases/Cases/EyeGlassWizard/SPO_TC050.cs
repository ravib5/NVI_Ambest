/* **********************************************************
 * Description : SPO_TC050.cs test case for Second Pair order eyeglasses
 *                Age: over 13 
 *                Patient Info: Any Patient's Prescription Type
 *                Lens Package: Verilite Package
 *                Lens Optional Tint: FashionTint for Frame 1 and Frame 2 and click Checkout
 *               
 * Date :  08-Mar-2016
 * **********************************************************
 */
...
namespace NationalVision.Automation.Tests.Cases.EyeGlassWizard
{
    ...
    /// <summary>
    /// Description : SPO_TC050.cs test case for Second Pair order eyeglasses Age: over 13,Patient Info: Any Patient's Prescription Type,
    ///              Lens Package: Verilite Package, Optional Tint: Fashion Tint for Frame1 and Frame2 and click Checkout
    ///              
    /// </summary>
    class SPO_TC050 : BaseCase
    {

/* **********************************************************
 * Description : SPO_TC045.cs test case for Second Pair order eyeglasses
 *                Age: over 13 
 *                Patient Info: Any Patient's Prescription Type
 *                Lens Package: Basic Package
 *                Optional Tint: No Tint for Frame 1 and Fashion Tint for Frame 2
...
namespace NationalVision.Automation.Tests.Cases.EyeGlassWizard
{
    ...
    /// <summary>
    /// Description : SPO_TC045.cs test case for Second Pair order eyeglasses Age: over 13,Patient Info: Any Patient's Prescription Type,
    ///              Lens Package: Basic Package, Optional Tint: No Tint for Frame 1 and Fashion Tint for Frame 2, 
    ///              Select Add A/R or No A/R for Frame1 and 2 and click Checkout
    /// </summary>
    class SPO_TC045 : BaseCase
    {
        protected override void ExecuteTestCase()
        {
            // **** Assigning product value to local variable to use mulitple place in same class ****//
            string _product = TestData["PRODUCT"];
            Reporter.Chapter.Title = "Verify Second Pair order for a patient over 13 years with Options:No Prescription,Basic package,No Tint and Fashion Tint with AntiReflective";
            ...
            Step = "Verifying Optional Tint options and selecting NoTint and SunglassTint for the Frames and Clicking Next";

/* **********************************************************
 * Description : SPO_TC044.cs test case for Second Pair order eyeglasses
 *                Age: over 13 
 *                Patient Info: Any Patient's Prescription Type
 *                Lens Package: Basic Package
 *                Optional Tint: Fashion Tint and click Checkout
 *               
 * Date :  03-March-2016
 * **********************************************************
 */
...
namespace NationalVision.Automation.Tests.Cases.EyeGlassWizard
{
    ...
    /// <summary>
    /// Description : SPO_TC044.cs test case for Second Pair order eyeglasses Age: over 13,Patient Info: Any Patient's Prescription Type,
    ///              Lens Package: Basic Package, Optional Tint: fashion Tint Option for Frame1 and Frame2 and click Checkout
    /// </summary>
    class SPO_TC044 : BaseCase
    {
        protected override void ExecuteTestCase()
        {
            ...
            Step = "Verifying Optional Tint options and selecting Fashion Tint for both the Frames and Clicking Next";

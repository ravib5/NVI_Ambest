/* **********************************************************
 * Description : SPO_TC041.cs test case for Second Pair order eyeglasses
 *                Age: over 13 
 *                Patient Info: Any Patient's Prescription Type
 *                Lens Package: No Package
 *                Lens Option: Scratch resistant lens coating
...
{
    /// <summary>
    /// Description : SPO_TC041.cs test case for Second Pair order eyeglasses Age: over 13,Patient Info: Any Patient's Prescription Type,
    ///              Lens Package: No Package, Lens Option: Scratch resistant lense coating, Select Add A/R or No A/R for Frame1 and 2 
    ///              and click Checkout
    /// </summary>
    class SPO_TC041 : BaseCase
    {
        protected override void ExecuteTestCase()
        {
            ...
            Step = "Verifying Lens Options and Selecting the option as 'Scratch Resistant Lens Coating' and Clicking Next";

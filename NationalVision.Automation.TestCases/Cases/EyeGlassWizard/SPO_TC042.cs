/* **********************************************************
 * Description : SPO_TC042.cs test case for Second Pair order eyeglasses
 *                Age: over 13 
 *                Patient Info: Any Patient's Prescription Type
 *                Lens Package: No Package
 *                Lens Option: Basic Package with NoTint
...
{
    /// <summary>
    /// Description : SPO_TC042.cs test case for Second Pair order eyeglasses Age: over 13,Patient Info: Any Patient's Prescription Type,
    ///              Lens Package: No Package, Lens Option: Basic ackage with NoTint, Select Add A/R or No A/R for Frame1 and 2 
    ///              and click Checkout
    /// </summary>
    class SPO_TC042 : BaseCase
    {
        protected override void ExecuteTestCase()
        {
            // **** Assigning product value to local variable to use mulitple place in same class ****//
            string _product = TestData["PRODUCT"];
            Reporter.Chapter.Title = "Verify Second Pair order for a patient over 13 years with Options:No Prescription,No package,Basic ackage with NoTint";

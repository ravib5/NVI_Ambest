/* **********************************************************
 * Description : SPO_TC046.cs test case for Second Pair order eyeglasses
 *                Age: over 13 
 *                Patient Info: Any Patient's Prescription Type
 *                Lens Package: Basic Package
 *                Lens Optional Tint: SunglassTint for both Frame1 and frame2
...
namespace NationalVision.Automation.Tests.Cases.EyeGlassWizard
{
    ...
    /// <summary>
    /// Description : SPO_TC046.cs test case for Second Pair order eyeglasses Age: over 13,Patient Info: Any Patient's Prescription Type,
    ///              Lens Package: Basic Package, Optional Tint: Sunglass Tint Option for Frame1 and Frame2, Select Add A/R or No A/R for Frame1 and Frame2
    ///              and click Checkout
    /// </summary>
    class SPO_TC046 : BaseCase
    {
        protected override void ExecuteTestCase()
        {
            // **** Assigning product value to local variable to use mulitple place in same class ****//
            string _product = TestData["PRODUCT"];
            Reporter.Chapter.Title = "Verify Second Pair order for a patient over 13 years with Options:No Prescription,Basic package,Sunglass Tint";
            ...
            Step = "Verifying Optional Tint options and selecting Sunglass Tint for both the Frames and Clicking Next";

/* **********************************************************
 * Description : SPO_TC047.cs test case for Second Pair order eyeglasses
 *                Age: over 13 
 *                Patient Info: Any Patient's Prescription Type
 *                Lens Package:  Basic Package
 *                Optional Tint: Fashion Tint for Frame 1 and Sun Glass Tint for Frame 2 and click Checkout
 *               
 * Date :  04-March-2016
 * **********************************************************
 */
...
namespace NationalVision.Automation.Tests.Cases.EyeGlassWizard
{
    ...
    /// <summary>
    /// Description : SPO_TC047.cs test case for Second Pair order eyeglasses Age: over 13,Patient Info: Any Patient's Prescription Type,
    ///              Lens Package: Basic Package, Optional Tint: Fashion Tint for Frame 1 and Sun Glass Tint for Frame 2 and click Checkout
    /// </summary>
    class SPO_TC047 : BaseCase
    {
        protected override void ExecuteTestCase()
        {
            // **** Assigning product value to local variable to use mulitple place in same class ****//
            string _product = TestData["PRODUCT"];
            Reporter.Chapter.Title = "Verify Second Pair order for a patient over 13 years with Options:No Prescription,Basic package,Fashion Tint";
            ...
            Step = "Verifing Lens package and Selecting 'Basic Package' under choose a Lens Package and Clicking Next";
            EyeGlassWizardPage.CheckLensPackage(Driver, Reporter);
            EyeGlassWizardPage.SelectLensPackage(Driver, Reporter, "basic");
            EyeGlassWizardPage.ClickNext(Driver, Reporter);

            Step = "Verifying Optional Tint options and selecting Fashion Tint for Frame1 and Clicking Next";
            EyeGlassWizardPage.CheckLensTintOptions(Driver, Reporter);
            EyeGlassWizardPage.SelectLensTintOptions(Driver, Reporter, "fashion");
            EyeGlassWizardPage.ClickNext(Driver, Reporter);

            Step = "Verifying Optional Tint options and selecting Sunglass Tint for Frame2 and Clicking Next";
            EyeGlassWizardPage.SelectLensTintOptions(Driver, Reporter, "sunglass");
            EyeGlassWizardPage.ClickNext(Driver, Reporter);

            Step = "Verifying AntiReflective options and selecting Anti A/R for both the Frames and Clicking Next";
            ...
            Step = "Verifying buttons under 'Review your selections' section";

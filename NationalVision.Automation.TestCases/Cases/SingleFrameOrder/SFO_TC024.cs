/* **********************************************************
 * Description : SPO_TC024.cs test cases for Single frame Order
 *               Age: over 13 
 *               Patient informtion: Prescription don't Know
 *               Lens Package: No Package
 *               Lens Options: Un-coatings       
 *               
 * Date :  15-Feb-2016
 * **********************************************************
 */
...
{
    /// <summary>
    /// Description : SPO_TC024.cs test cases for Single frame Order; Age: over 13; Patient information: Prescription don't Know
    ///               Lens Package: No Package; Lens Options: Un-Coatings   
    /// </summary>
    class SFO_TC024 : BaseCase
    {
        protected override void ExecuteTestCase()
        {
            Reporter.Chapter.Title = "Verify single frame order - for a patient over 13 years ";
            ...
            Step = "Select 'Women's Frames' under 'Shop By Type' Menu";
            ...
            Step = "Selecting 'NoPackageUncoated' under select your lens option and click on Next";

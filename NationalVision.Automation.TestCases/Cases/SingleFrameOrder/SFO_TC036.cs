...
{
    class SFO_TC036 : BaseCase
    {
        /// <summary>
        /// Description : SFO_TC036.cs Single Frame Order, Age: over 13, Patient Options: I Know Patient's Ptrescription, Lens Packages: Basic Package
        /// Optional Tint: Sun glasses Tint, Verify Product Details in Review Section then Click CheckOut
        /// </summary>

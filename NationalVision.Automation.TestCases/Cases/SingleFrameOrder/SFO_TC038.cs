/* **********************************************************
 * Description : SFO_TC038.cs Single Frame Order
 *                           Age: over 13
 *                           Patient Options: I Know the Patient's Prescription
 *                           Lens Packages: Verilite Package
...
{
    class SFO_TC038 : BaseCase
    {
        /// <summary>
        /// Description : SFO_TC038.cs Single Frame Order, Age: over 13, Patient Options: I Know Patient's Ptrescription, Lens Packages: Verilite Package
        /// Optional Tint: Fashion Tint, Verify Product Details in Review Section then Click CheckOut
        /// </summary>
        protected override void ExecuteTestCase()
        {
            Reporter.Chapter.Title = "Verifying Single Frame Order for a patient >13 years with I Know Patient's Prescription,Verilite Package Lens Options, Fashion Tint";

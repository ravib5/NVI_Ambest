/* **********************************************************
 * Description : SFO_TC029.cs test cases for Single frame Order
 *               Age: over 13 
 *               Patient informtion: Prescription don't Know
 *               Lens Package: Verilite Package
 *               Lens Options: No Tint  
 *               
 * Date :  23-Feb-2016
 * **********************************************************
 */
...
{
    /// <summary>
    ///  Description : SFO_TC029.cs test cases for Single frame Order; Age: over 13; Patient information: Prescription don't Know
    ///                 Lens Package: Basic Package; Lens Options: sun glasses Tint
    /// </summary>
    class SFO_TC029 : BaseCase
    {
        protected override void ExecuteTestCase()
        {
            ...
            Step = "Selecting 'verilite Package' under choose a Lens Package and Click on Next";
            EyeGlassWizardPage.SelectLensPackage(Driver, Reporter, "verilite");
            EyeGlassWizardPage.ClickNext(Driver, Reporter);

            Step = "Verifying No tint, Fashion tint options in Choose an optional tint page";
            EyeGlassWizardPage.CheckVeriliteLensTintOptions(Driver, Reporter);

            Step = "Selecting 'No tint' as an optional tint and click next";

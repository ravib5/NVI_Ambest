/* **********************************************************
 * Description : SFO_TC017.cs Single Frame Order
 *                           Age: over 13
 *                           Patient Options: Just Browsing
 *                           Lens Packages: No Package
 *                           Lens Options: Scracth
...
{
    class SFO_TC017 : BaseCase
    {
        /// <summary>
        /// Description : SFO_TC017.cs Single Frame Order, Age: over 13, Patient Options: Just Browsing, Lens Packages: No Package
        /// Lens Options: Scracth, Lens Tint Options: No Tint, Verify Product Details in Review Section then Click CheckOut
        /// </summary>
        protected override void ExecuteTestCase()
        {
            Reporter.Chapter.Title = "Verifying Single Frame Order for a patient >13 years with No Scratch, No Tint Options";
            ...
            Step = "Clicking on Scratch Resistant Lens Coating Option and Click on Next";

/* **********************************************************
 * Description : SFO_TC020.cs for Single frame Order with below options 
                             Age :over 13;
 *                           Patinet Options: Just Browsing;
 *                           EyeGlasses Packages: No Package;
 *                           Lens Options: Basic Package
 *                           Lens Tint Options: Sunglasses Tint
...
{
    class SFO_TC020 : BaseCase
    {
        /// <summary>
        /// Description : SFO_TC020.cs for Single frame Order with below options; Age :over 13; Patient Options: Just Browsing;
        ///             EyeGlasses Packages: No Package; Lens Options: Basic Package; Lens Tint Options: Sunglasses Tint
        ///             Verify Product Details in Review Section and Click CheckOut
        /// </summary>
        protected override void ExecuteTestCase()
        {
            ...
            Reporter.Chapter.Title = "Verify SingleFrame Order for a patient over 13 years with options:'No package, BasicOptions Package with Sunglasses Tint'";
            ...
            Step = "Selecting the SunGlass Option in Optional Tint";

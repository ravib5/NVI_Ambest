/* **********************************************************
 * Description : SFO_TC037.cs Single Frame Order
 *                           Age: over 13
...
{
    class SFO_TC037 : BaseCase
    {
        /// <summary>
        /// Description : SFO_TC037.cs Single Frame Order, Age: over 13, Patient Options: I Know Patient's Ptrescription, Lens Packages: Verilite Package
        /// Optional Tint: NO Tint, Verify Product Details in Review Section then Click CheckOut
        /// </summary>
        protected override void ExecuteTestCase()
        {
            ...
            Step = "Clicking on verilite Package Option";

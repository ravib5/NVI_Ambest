...
{
    class SFO_TC034 : BaseCase
    {
        /// <summary>
        /// Description : SFO_TC034.cs Single Frame Order, Age: over 13, Patient Options: I Know Patient's Ptrescription, Lens Packages: No Package
        /// Lens Options: Basic Package,Optional Tint: No Tint, Verify Product Details in Review Section then Click CheckOut
        /// </summary>
        protected override void ExecuteTestCase()
        {
            Reporter.Chapter.Title = "Verifying Single Frame Order for a patient >13 years with I Know Patient's Prescription,No Package,Basic Package Lens Options, No Tint";
            ...
            Step = "Clicking on basic Lens Coating Option and Click on Next";
            ...
            Step = "Choosing No Tint Option in EyeGlass Wizard Page";

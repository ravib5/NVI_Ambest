/* **********************************************************
 * Description : SFO_TC033.cs test cases for Single frame Order
 *               Age: over 13 
 *               Patient informtion: I know the patient's prescription
...
{
    /// <summary>
    ///  Description : SFO_TC033.cs test cases for Single frame Order; Age: over 13; Patient information: I know the patient's prescription
    ///                 Lens Package: NO Package; Lens Options: Scratch resistant lens coating
    /// </summary>
    class SFO_TC033 : BaseCase
    {
        protected override void ExecuteTestCase()
        {
            ...
            Step = "Clicking on I know the patient's prescription";

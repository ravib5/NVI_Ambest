/* **********************************************************
 * Description : SFO_TC032.cs Single Frame Order
 *                           Age: over 13
 *                           Patient Options: I Know the Patient's Prescription
 *                           Lens Packages: No Package
 *                           Lens Options: No Package Uncoated
...
{
    class SFO_TC032 : BaseCase
    {
        /// <summary>
        /// Description : SFO_TC032.cs Single Frame Order, Age: over 13, Patient Options: I Know Patient's Ptrescription, Lens Packages: No Package
        /// Lens Options: No Package Uncoated, Verify Product Details in Review Section then Click CheckOut
        /// </summary>
        protected override void ExecuteTestCase()
        {
            Reporter.Chapter.Title = "Verifying Single Frame Order for a patient >13 years with I Know Patient's Prescription";

/* **********************************************************
 * Description : SFO_TC019.cs for Single frame Order with below options 
 *                           Age :over 13;
...
{
    /// <summary>
    /// Description : SFO_TC019.cs test cases for Single frame Order with below options; Age :over 13; Patient Options: Just Browsing;
    /// EyeGlasses Packages: No Package; Lens Options: Basic Package; Lens Tint Options: Fashion Tint, Verify Product Details
    /// in Review Section and Click CheckOut
    /// </summary>
    class SFO_TC019 : BaseCase
    {
        protected override void ExecuteTestCase()
        {
            Reporter.Chapter.Title = "Verify Single Frame Order for a patient age > 13 years with LensTint: Fashion Tint";
            ...
            Step = "Selecting the Fashion Tint Option in Optional Tint";
